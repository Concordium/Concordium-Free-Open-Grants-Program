...
The treasury is a pot of on-chain funds collected through transaction fees,part of the baking rewards , staking inefficiencies, etc. The funds held in the treasury can be spent on spending proposals. [Concordium](https://concordium.com) offers everyone the opportunity to apply for funding via the treasury. 
